...
export default function LandingPage({authenticatedUser, setAuthenticatedUser}) {
  ...
  function handleSearch() {
    ...
    if (text == "") {
      ...
      Axios.get(`api/products/search/${text}`)
        .then(function (response) {
          // handle success
          setProducts(response.data.products);
        })
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <div className="buttonfooter">
                <button onClick={handleLoginUser} type="button" className="login" data-bs-dismiss="modal">
                  Login
                </button>
      ...
      <div className="modal fade" id="register-modal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-sm modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button onClick={handleRegisterUser} type="button" className="register w-75 m-0" data-bs-dismiss="modal">
                Register
              </button>
              <div className="mt-4">Or login using</div>
              <div className="mb-3">
